...
// Use numeric values to avoid enum name collisions with newer SDK headers.
...
void Win32Window::UpdateTheme(HWND const window) {
  ...
  // Apply a subtle translucent backdrop on supported Windows versions.
  const DWORD backdrop = 2;  // DWMSBT_MAINWINDOW
  HRESULT backdrop_result =
